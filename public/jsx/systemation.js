var React     = require('react'),
    ...
    var SunForm = React.createClass({
          ...
          render: function(){
            ...
            var camera = new THREE.PerspectiveCamera(75, 600/ 600, 0.1, 10000);
            ...
            return(
              ...
              <div id="results-container">
                <form className="SunForm" onSubmit={this.handleAddPlanet}>
                ...
                <form className="SunForm" onSubmit={this.radiusUp}>
                  <button className="btn btn-primary" type="submit" value="post">+</button>
                </form>
                <form className="SunForm" onSubmit={this.radiusDown}>
                  <button className="btn btn-primary" type="submit" value="post">-</button>
                </form>
                <form className="SunForm" onSubmit={this.handleSubmit}>
                  <input id="search-box" type="text" placeholder="Radius" onChange={this.handleRotationChange} value={this.state.rotation}/>
                </form>
                <form className="SunForm" onSubmit={this.rotationUp}>
                  <button className="btn btn-primary" type="submit" value="post">+</button>
                </form>
                <form className="SunForm" onSubmit={this.rotationDown}>
                  <button className="btn btn-primary" type="submit" value="post">-</button>
                </form>
                <form className="SunForm" onSubmit={this.handleSubmit}>
                  <input id="search-box" type="text" placeholder="Radius" onChange={this.handleTiltChange} value={this.state.tilt}/>
                </form>
                <form className="SunForm" onSubmit={this.tiltUp}>
                  <button className="btn btn-primary" type="submit" value="post">+</button>
                </form>
                <form className="SunForm" onSubmit={this.tiltDown}>
                  <button className="btn btn-primary" type="submit" value="post">-</button>
                </form>
                <div id='results-zone'>
...
ReactDOM.render(<SunForm/>, document.getElementById('star-control'))
