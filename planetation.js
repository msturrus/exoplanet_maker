...
var PlanetForm = React.createClass({
      getInitialState: function(){
        return {planets: [], radius: 1, name: "TestPlanet", rotation: .01, tilt: 0}
      },
    ...
    ReactDOM.render(<PlanetForm/>, document.getElementById('zone-container'))
...
// {
//   this.state.planets.map(function(planet, i){
//     return <Planet rotation={planet.rotation} album={album.albumName} artist={album.albumArtist} location={1} key={i} />
//   }.bind(this))
// }
